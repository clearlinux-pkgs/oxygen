...
Source0  : https://download.kde.org/stable/plasma/6.3.0/oxygen-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/oxygen-6.3.0.tar.xz.sig
...
%setup -q -n oxygen-6.3.0
cd %{_builddir}/oxygen-6.3.0
pushd ..
cp -a oxygen-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739303302
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liboxygenstyle6.so.6.3.0
/V3/usr/lib64/liboxygenstyleconfig6.so.6.3.0
...
/usr/lib64/liboxygenstyle6.so.6.3.0
/usr/lib64/liboxygenstyleconfig6.so.6
/usr/lib64/liboxygenstyleconfig6.so.6.3.0
