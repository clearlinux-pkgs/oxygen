...
Source0  : https://download.kde.org/stable/plasma/5.23.4/oxygen-5.23.4.tar.xz
...
%prep
%setup -q -n oxygen-5.23.4
cd %{_builddir}/oxygen-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638356252
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/oxygen-5.23.4/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/oxygen/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/oxygen-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/oxygen/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/oxygen-5.23.4/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/oxygen/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/oxygen-5.23.4/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/oxygen/e3bdbf20d43fc066a1b40a64d57d4ae5a31f177f
cp %{_builddir}/oxygen-5.23.4/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/oxygen/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/oxygen-5.23.4/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/oxygen/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/oxygen-5.23.4/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/oxygen/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/oxygen-5.23.4/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/oxygen/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/oxygen-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/oxygen/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/oxygen-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/oxygen/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/oxygen-5.23.4/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/oxygen/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/oxygen-5.23.4/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/oxygen/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/oxygen-5.23.4/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/oxygen/81e12d0c07782abcf558af7aa19846e3e2606a70
cp %{_builddir}/oxygen-5.23.4/cursors/LICENSE %{buildroot}/usr/share/package-licenses/oxygen/e7d563f52bf5295e6dba1d67ac23e9f6a160fab9
pushd clr-build
%make_install
popd
...
/usr/lib64/liboxygenstyle5.so.5.23.4
/usr/lib64/liboxygenstyleconfig5.so.5
/usr/lib64/liboxygenstyleconfig5.so.5.23.4
