...
Source0  : https://download.kde.org/stable/plasma/6.0.4/oxygen-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/oxygen-6.0.4.tar.xz.sig
...
%setup -q -n oxygen-6.0.4
cd %{_builddir}/oxygen-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713321193
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liboxygenstyle6.so.6.0.4
/V3/usr/lib64/liboxygenstyleconfig6.so.6.0.4
...
/usr/lib64/liboxygenstyle6.so.6.0.4
/usr/lib64/liboxygenstyleconfig6.so.6
/usr/lib64/liboxygenstyleconfig6.so.6.0.4
