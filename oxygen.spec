...
Version  : 6.3.1
Release  : 21
URL      : https://download.kde.org/stable/plasma/6.3.1/oxygen-6.3.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.1/oxygen-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/oxygen-6.3.1.tar.xz.sig
...
%setup -q -n oxygen-6.3.1
cd %{_builddir}/oxygen-6.3.1
pushd ..
cp -a oxygen-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739903872
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liboxygenstyle6.so.6.3.1
/V3/usr/lib64/liboxygenstyleconfig6.so.6.3.1
...
/usr/lib64/liboxygenstyle6.so.6.3.1
/usr/lib64/liboxygenstyleconfig6.so.6
/usr/lib64/liboxygenstyleconfig6.so.6.3.1
