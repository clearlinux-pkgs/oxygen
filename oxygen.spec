...
Source0  : https://download.kde.org/stable/plasma/5.13.5/oxygen-5.13.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.13.5/oxygen-5.13.5.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0 GPL-3.0 LGPL-2.1 LGPL-3.0
Requires: oxygen-bin
Requires: oxygen-lib
Requires: oxygen-license
Requires: oxygen-data
Requires: oxygen-locales
...
export LANG=C
export SOURCE_DATE_EPOCH=1536088687
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1536088687
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/oxygen
cp COPYING %{buildroot}/usr/share/doc/oxygen/COPYING
cp COPYING.LIB %{buildroot}/usr/share/doc/oxygen/COPYING.LIB
cp cursors/LICENSE %{buildroot}/usr/share/doc/oxygen/cursors_LICENSE
cp cursors/src/LICENSE %{buildroot}/usr/share/doc/oxygen/cursors_src_LICENSE
pushd clr-build
%make_install
popd
...
/usr/lib64/liboxygenstyle5.so.5.13.5
/usr/lib64/liboxygenstyleconfig5.so.5
/usr/lib64/liboxygenstyleconfig5.so.5.13.5
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/oxygen/COPYING
/usr/share/doc/oxygen/COPYING.LIB
/usr/share/doc/oxygen/cursors_LICENSE
/usr/share/doc/oxygen/cursors_src_LICENSE
