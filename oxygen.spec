...
%setup -q -n oxygen-6.2.5
cd %{_builddir}/oxygen-6.2.5
pushd ..
cp -a oxygen-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736183960
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liboxygenstyle6.so.6.2.5
/V3/usr/lib64/liboxygenstyleconfig6.so.6.2.5
...
/usr/lib64/liboxygenstyle6.so.6.2.5
/usr/lib64/liboxygenstyleconfig6.so.6
/usr/lib64/liboxygenstyleconfig6.so.6.2.5
