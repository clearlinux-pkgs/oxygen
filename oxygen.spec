...
Version  : 6.1.1
Release  : 9
URL      : https://download.kde.org/stable/plasma/6.1.1/oxygen-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/oxygen-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/oxygen-6.1.1.tar.xz.sig
...
%setup -q -n oxygen-6.1.1
cd %{_builddir}/oxygen-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719421225
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liboxygenstyle6.so.6.1.1
/V3/usr/lib64/liboxygenstyleconfig6.so.6.1.1
...
/usr/lib64/liboxygenstyle6.so.6.1.1
/usr/lib64/liboxygenstyleconfig6.so.6
/usr/lib64/liboxygenstyleconfig6.so.6.1.1
