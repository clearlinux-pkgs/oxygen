...
Source0  : https://download.kde.org/stable/plasma/5.26.4/oxygen-5.26.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.4/oxygen-5.26.4.tar.xz.sig
...
%prep
%setup -q -n oxygen-5.26.4
cd %{_builddir}/oxygen-5.26.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669817716
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/liboxygenstyle5.so.5.26.4
/usr/lib64/liboxygenstyleconfig5.so.5
/usr/lib64/liboxygenstyleconfig5.so.5.26.4
